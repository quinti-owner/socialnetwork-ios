...
struct ProfileSerchMember: Codable{
    var no: String
    var member_rid: String
    var name: String
    var sex: String
    var generation_rid: String
    var generation: String
    var status: String
    var pref_id: String
    var pref: String
    var comment: String
    var comment_is_sensitive: String
    var city_id: String
    var city: String
    var has_history_mail: String
    ...
    var height: String
    var style: String
    var photo_urls: ProfileSerchMemberPhotoUrls
    var typed: String
    ...
    var memo: ProfileSerchMemberMemo
    var profile: ProfileSerchMemberProfile
    var place: String
}
